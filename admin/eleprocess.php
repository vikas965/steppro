...
function storeInDatabase($sheetData) {
    ...
    foreach ($sheetData as $row) {
        ...
        $column6 = mysqli_real_escape_string($con, $row['F']);
        $column7 = mysqli_real_escape_string($con, $row['G']);

        
        $sql = "INSERT INTO  electives(course_id,branch_id,course_name,semester,no_seats,refined_branch,std_count_branch) VALUES('$column1','$column2','$column3',$column4,$column5,'$column6',$column7)";
